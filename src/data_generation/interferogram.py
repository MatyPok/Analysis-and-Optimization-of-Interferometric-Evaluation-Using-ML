...
class Interferogram():
    ...
    def __init__(self, zernikes: np.ndarray, size: int=1024, wavelength: float=632.8e-9, show: bool=False) -> None:
...
if __name__ == "__main__":
    ...
    generated_interferograms = Interferogram(multi_set_zernikes).generate()
